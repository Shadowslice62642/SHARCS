...
//corners_p
    uint8_t* move_U_perm(uint8_t corners_p[8], int a){ // U
        uint8_t x;
        x = corners_p[0];
    ...
    uint8_t* move_L_perm(uint8_t corners_p[8], int a){ // L
        uint8_t x;
        x = corners_p[0];
    ...
    uint8_t* move_F_perm(uint8_t corners_p[8], int a){ // F
        uint8_t x;
        x = corners_p[0];
    ...
    uint8_t* move_R_perm(uint8_t corners_p[8], int a){ // R
        uint8_t x;
        x = corners_p[2];
    ...
    uint8_t* move_B_perm(uint8_t corners_p[8], int a){ // B
        uint8_t x;
        x = corners_p[1];
    ...
    uint8_t* move_D_perm(uint8_t corners_p[8], int a){ // D
        uint8_t x;
        x = corners_p[4];
...
//corners_o
    uint8_t* move_U_ori(uint8_t corners_o[8], int a){ // U
        uint8_t x;
        x = corners_o[0];
    ...
    uint8_t* move_L_ori(uint8_t corners_o[8], int a){ // L
        uint8_t x;
        x = corners_o[0];
    ...
    uint8_t* move_F_ori(uint8_t corners_o[8], int a){ // F
        uint8_t x;
        x = corners_o[0];
    ...
    uint8_t* move_R_ori(uint8_t corners_o[8], int a){ // R
        uint8_t x;
        x = corners_o[2];
    ...
    uint8_t* move_B_ori(uint8_t corners_o[8], int a){ // B
        uint8_t x;
        x = corners_o[1];
    ...
    uint8_t* move_D_ori(uint8_t corners_o[8], int a){ // D
        uint8_t x;
        x = corners_o[4];
...
//edges_p
    uint8_t* move_U_perm(uint8_t edges_p[12]){ // U
        uint8_t x;
        x = edges_p[0];
        edges_p[0] = edges_p[3];
        edges_p[3] = edges_p[2];
    ...
    uint8_t* move_L_perm(uint8_t edges_p[12]){ // L
        uint8_t x;
        x = edges_p[1];
        edges_p[1] = edges_p[4];
        edges_p[4] = edges_p[9];
    ...
    uint8_t* move_F_perm(uint8_t edges_p[12]){ // F
        uint8_t x;
        x = edges_p[0];
        edges_p[0] = edges_p[5];
    ...
    uint8_t* move_R_perm(uint8_t edges_p[12]){ // R
        uint8_t x;
        x = edges_p[3];
        edges_p[3] = edges_p[6];
    ...
    uint8_t* move_B_perm(uint8_t edges_p[12]){ // B
        uint8_t x;
        x = edges_p[2];
        edges_p[2] = edges_p[7];
        edges_p[7] = edges_p[8];
    ...
    uint8_t* move_D_perm(uint8_t edges_p[12]){ // D
        uint8_t x;
        x = edges_p[8];
    ...
    uint8_t* move_M_perm(uint8_t edges_p[12]){ // M
        uint8_t x;
        x = edges_p[0];
    ...
    uint8_t* move_S_perm(uint8_t edges_p[12]){ // S
        uint8_t x;
        x = edges_p[1];
        edges_p[1] = edges_p[9];
    ...
    uint8_t* move_E_perm(uint8_t edges_p[12]){ // E
        uint8_t x;
        x = edges_p[4];
        edges_p[4] = edges_p[5];
        edges_p[5] = edges_p[6];
...
//edges_o
    uint8_t* move_U_ori(uint8_t edges_o[12]){ // U
        uint8_t x;
        x = edges_o[0];
        edges_o[0] = edges_o[3];
        edges_o[3] = edges_o[2];
    ...
    uint8_t* move_L_ori(uint8_t edges_o[12]){ // L
        uint8_t x;
        x = edges_o[1];
        edges_o[1] = edges_o[4];
        edges_o[4] = edges_o[9];
    ...
    uint8_t* move_F_ori(uint8_t edges_o[12]){ // F
        uint8_t x;
        x = edges_o[0];
    ...
    uint8_t* move_R_ori(uint8_t edges_o[12]){ // R
        uint8_t x;
        x = edges_o[3];
        edges_o[3] = edges_o[6];
    ...
    uint8_t* move_B_ori(uint8_t edges_o[12]){ // B
        uint8_t x;
        x = edges_o[2];
    ...
    uint8_t* move_D_ori(uint8_t edges_o[12]){ // D
        uint8_t x;
        x = edges_o[8];
    ...
    uint8_t* move_M_ori(uint8_t edges_o[12]){ // M
        uint8_t x;
        x = edges_o[0];
    ...
    uint8_t* move_S_ori(uint8_t edges_o[12]){ // S
        uint8_t x;
        x = edges_o[1];
    ...
    uint8_t* move_E_ori(uint8_t edges_o[12]){ // E
        uint8_t x;
        x = edges_o[4];
